"""
Clasificador WRB basado en reglas JRip — Sensores sensor multinivel
=========================================================
Origen de las reglas: results/clips_jrip_sensor multinivel_1000.clp
Algoritmo: JRip (RIPPER) entrenado en Weka con sensor multinivel_wrb_classify_ready.csv
...
# ---------------------------------------------------------------------------
# Ejecucion directa: clasifica sensor multinivel_wrb_classify_ready.csv
# ---------------------------------------------------------------------------
if __name__ == "__main__":
    ...
    csv_path = root / "sensor multinivel_wrb_classify_ready.csv"
